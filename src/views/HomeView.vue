...
<template>
  ...
  >
    <div
      class="NoteList py-2 gap-4 h-full flex flex-col items-center justify-start bg-black bg-opacity-20 border border-gray-700 border-opacity-30 min-w-48 max-w-96 overflow-auto resize-x px-[10px] w-1/3"
    >
      <div
      ...
      >
        ...
        <action-bar-button
          variant="Default"
          @click="createNote('Untitled ' + note.length, '', new Date().toLocaleDateString())"
        >
    ...
    <div
      class="NoteContent h-full w-full inline-flex flex-col items-start justify-start pb-2.5 bg-black bg-opacity-30"
    >
      <div
